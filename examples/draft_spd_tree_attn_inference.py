...
def prepare_decode_dlm_inputs(
    ...
    Args:
        ...
        valid_num_tokens_selected (np.ndarray): number of accepted target tokens, shape: [decode_batch_size]
...
def speculate_tokens(draft_model_session, dlm_decode_inputs, valid_batch_indices, num_speculative_tokens, spec_decode_nst_topk):
